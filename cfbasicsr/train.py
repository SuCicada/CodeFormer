...
from cfbasicsr.data import build_dataloader, build_dataset
from cfbasicsr.data.data_sampler import EnlargedSampler
from cfbasicsr.data.prefetch_dataloader import CPUPrefetcher, CUDAPrefetcher
from cfbasicsr.models import build_model
from cfbasicsr.utils import (MessageLogger, check_resume, get_env_info, get_root_logger, init_tb_logger,
                           init_wandb_logger, make_exp_dirs, mkdir_and_rename, set_random_seed)
from cfbasicsr.utils.dist_util import get_dist_info, init_dist
from cfbasicsr.utils.options import dict2str, parse
...
def init_loggers(opt):
    ...
    logger = get_root_logger(logger_name='cfbasicsr', log_level=logging.INFO, log_file=log_file)
